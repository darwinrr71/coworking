...
import publicAvailabilityRateLimit from '../middleware/publicAvailabilityRateLimit.js';

router.post('/booking/create', authMiddleware.authenticate, bookingController.createBooking);
router.post('/bookings/validate', authMiddleware.authenticate, bookingController.validateBookingIntervals);
router.post('/bookings/bulk', authMiddleware.authenticate, bookingController.createBulkBookings);
router.get('/booking/allbooking', authMiddleware.authenticate, bookingController.getUserBookings);
router.get('/availability/public', publicAvailabilityRateLimit, bookingController.getAvailability);
router.get('/availability', authMiddleware.authenticate, bookingController.getAvailability);
